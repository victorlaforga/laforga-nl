    ...
    <section className="section-faq">
      <div className="container" lang={lang}>
        ...
        <Faq
          ...
          agencies alleen per uur werken, proberen we de
        ...
        <Faq
          ...
          zich richt op technologiebedrijven, digitale producten en
        ...
        <Faq
          ...
          description="Wij zijn een full-service e-commerce agency waarbij wij het
                  complete pakket aanbieden. Van strategie tot het developen
                  ervan. We hebben een compleet team met specialisten."
        />
      </div>
    </section>
  );
